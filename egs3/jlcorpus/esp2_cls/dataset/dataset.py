"""JL-Corpus dataset implementation backed by TSV manifests."""
...
from egs3.jlcorpus.esp2_cls.dataset.builder import JLCorpusBuilder, resolve_data_root
...
class JLCorpusDataset(TorchDataset):
    """JL-Corpus dataset that returns ``{"speech", "label"}`` samples.
    ...
    Examples:
        >>> dataset = JLCorpusDataset(split="valid")
