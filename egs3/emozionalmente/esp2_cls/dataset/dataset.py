"""Emozionalmente dataset implementation backed by TSV manifests."""
...
class EmozionalmenteDataset(TorchDataset):
    """Emozionalmente dataset that returns ``{"speech", "label"}`` samples.
    ...
    Examples:
        >>> dataset = EmozionalmenteDataset(split="valid")
