"""EMNS dataset implementation backed by TSV manifests."""
...
from egs3.emns.esp2_cls.dataset.builder import EMNSBuilder, resolve_data_root
...
class EMNSDataset(TorchDataset):
    """EMNS dataset that returns ``{"speech", "label"}`` samples.
    ...
    Examples:
        >>> dataset = EMNSDataset(split="valid")
