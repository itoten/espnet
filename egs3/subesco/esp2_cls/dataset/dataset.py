"""SUBESCO dataset implementation backed by TSV manifests."""
...
from egs3.subesco.esp2_cls.dataset.builder import SUBESCOBuilder, resolve_data_root
...
class SUBESCODataset(TorchDataset):
    """SUBESCO dataset that returns ``{"speech", "label"}`` samples.
    ...
    Examples:
        >>> dataset = SUBESCODataset(split="valid")
