"""Quechua Collao dataset implementation backed by TSV manifests."""
...
from egs3.quechua.esp2_cls.dataset.builder import QuechuaBuilder, resolve_data_root
...
class QuechuaDataset(TorchDataset):
    """Quechua Collao dataset that returns ``{"speech", "label"}`` samples.
    ...
    Examples:
        >>> dataset = QuechuaDataset(split="valid")
