"""Thorsten-Emotional dataset implementation backed by TSV manifests."""
...
from egs3.thorsten.esp2_cls.dataset.builder import ThorstenBuilder, resolve_data_root
...
class ThorstenDataset(TorchDataset):
    """Thorsten-Emotional dataset that returns ``{"speech", "label"}`` samples.
    ...
    Examples:
        >>> dataset = ThorstenDataset(split="valid")
