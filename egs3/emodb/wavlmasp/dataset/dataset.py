"""EmoDB dataset implementation backed by TSV manifests."""
...
from egs3.emodb.wavlmasp.dataset.builder import EmoDBBuilder, resolve_data_root
...
class EmoDBDataset(TorchDataset):
    """EmoDB dataset that returns ``{"speech", "label"}`` samples.
    ...
    Examples:
        >>> dataset = EmoDBDataset(split="valid")
