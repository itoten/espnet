"""CREMA-D dataset implementation backed by TSV manifests."""
...
from egs3.cremad.esp2_cls.dataset.builder import CremaDBuilder, resolve_data_root
...
class CremaDDataset(TorchDataset):
    """CREMA-D dataset that returns ``{"speech", "label"}`` samples.
    ...
    Examples:
        >>> dataset = CremaDDataset(split="valid")
